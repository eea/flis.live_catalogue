...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Catalogue.draft'
        db.delete_column(u'live_catalogue_catalogue', 'draft')


    def backwards(self, orm):
        # Adding field 'Catalogue.draft'
        db.add_column(u'live_catalogue_catalogue', 'draft',
