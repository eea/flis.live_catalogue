...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Catalogue.status'
        db.alter_column(u'live_catalogue_catalogue', 'status', self.gf('django.db.models.fields.CharField')(max_length=32))

    def backwards(self, orm):

        # Changing field 'Catalogue.status'
        db.alter_column(u'live_catalogue_catalogue', 'status', self.gf('django.db.models.fields.CharField')(max_length=10))
