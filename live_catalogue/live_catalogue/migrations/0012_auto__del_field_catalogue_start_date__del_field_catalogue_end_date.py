...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Catalogue.start_date'
        db.delete_column(u'live_catalogue_catalogue', 'start_date')

        # Deleting field 'Catalogue.end_date'
        db.delete_column(u'live_catalogue_catalogue', 'end_date')


    def backwards(self, orm):
        # Adding field 'Catalogue.start_date'
        db.add_column(u'live_catalogue_catalogue', 'start_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Catalogue.end_date'
        db.add_column(u'live_catalogue_catalogue', 'end_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)
