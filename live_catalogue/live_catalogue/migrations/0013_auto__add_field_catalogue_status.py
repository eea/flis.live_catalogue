...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Catalogue.status'
        db.add_column(u'live_catalogue_catalogue', 'status',
                      self.gf('django.db.models.fields.CharField')(default='open', max_length=10, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Catalogue.status'
        db.delete_column(u'live_catalogue_catalogue', 'status')
