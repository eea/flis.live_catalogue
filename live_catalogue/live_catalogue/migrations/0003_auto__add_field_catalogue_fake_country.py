...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Catalogue.fake_country'
        db.add_column(u'live_catalogue_catalogue', 'fake_country',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['common.Country'], blank=True),
                      keep_default=False)

        # Adding M2M table for field fake_themes on 'Catalogue'
        m2m_table_name = db.shorten_name(u'live_catalogue_catalogue_fake_themes')
    ...
    def backwards(self, orm):
        # Deleting field 'Catalogue.fake_country'
        db.delete_column(u'live_catalogue_catalogue', 'fake_country_id')

        # Removing M2M table for field fake_themes on 'Catalogue'
        db.delete_table(db.shorten_name(u'live_catalogue_catalogue_fake_themes'))
    ...
    models = {
        ...
        u'live_catalogue.catalogue': {
            ...
            'fake_country': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['common.Country']", 'blank': 'True'}),
