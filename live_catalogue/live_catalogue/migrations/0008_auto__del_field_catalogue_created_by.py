...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Catalogue.created_by'
        db.delete_column(u'live_catalogue_catalogue', 'created_by')


    def backwards(self, orm):
        # Adding field 'Catalogue.created_by'
        db.add_column(u'live_catalogue_catalogue', 'created_by',
