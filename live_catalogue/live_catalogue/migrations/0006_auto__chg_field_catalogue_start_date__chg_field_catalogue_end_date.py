...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Catalogue.start_date'
        db.alter_column(u'live_catalogue_catalogue', 'start_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Catalogue.end_date'
        db.alter_column(u'live_catalogue_catalogue', 'end_date', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Catalogue.start_date'
        db.alter_column(u'live_catalogue_catalogue', 'start_date', self.gf('django.db.models.fields.DateField')(default=''))

        # Changing field 'Catalogue.end_date'
        db.alter_column(u'live_catalogue_catalogue', 'end_date', self.gf('django.db.models.fields.DateField')(default=''))
