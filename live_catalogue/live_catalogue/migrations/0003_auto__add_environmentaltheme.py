...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'live_catalogue_environmentaltheme', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=64)),
        ))
        db.send_create_signal(u'live_catalogue', ['EnvironmentalTheme'])

        # Adding M2M table for field new_themes on 'Catalogue'
        m2m_table_name = db.shorten_name(u'live_catalogue_catalogue_new_themes')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('catalogue', models.ForeignKey(orm[u'live_catalogue.catalogue'], null=False)),
            ('environmentaltheme', models.ForeignKey(orm[u'live_catalogue.environmentaltheme'], null=False))
        ))
        db.create_unique(m2m_table_name, ['catalogue_id', 'environmentaltheme_id'])


    def backwards(self, orm):
        # Deleting model 'EnvironmentalTheme'
        db.delete_table(u'live_catalogue_environmentaltheme')

        # Removing M2M table for field new_themes on 'Catalogue'
        db.delete_table(db.shorten_name(u'live_catalogue_catalogue_new_themes'))
    ...
    models = {
        u'live_catalogue.catalogue': {
            ...
            'new_themes': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['live_catalogue.EnvironmentalTheme']", 'symmetrical': 'False', 'blank': 'True'}),
