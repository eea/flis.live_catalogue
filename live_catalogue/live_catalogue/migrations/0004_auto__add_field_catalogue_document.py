...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Catalogue.document'
        db.add_column(u'live_catalogue_catalogue', 'document',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Catalogue.document'
        db.delete_column(u'live_catalogue_catalogue', 'document')
